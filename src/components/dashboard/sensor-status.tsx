...
export function SensorStatus({ sensors }: SensorStatusProps) {
  return (
    <div className="p-4 rounded-xl border border-[#1e3a5f] bg-[#091a2e]">
      {/* Title */}
        ...
        {SENSORS.map((s) => {
          ...
          return (
            <div
              ...
              style={{ background: "#0d2137", border: `1px solid ${s.color}18` }}
            >
              <div className="flex items-center justify-between mb-1.5">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-mono font-bold text-white">
                    {typeof value === "number" && value % 1 !== 0 ? value.toFixed(s.id === "ph" ? 2 : 1) : value.toFixed(0)}
